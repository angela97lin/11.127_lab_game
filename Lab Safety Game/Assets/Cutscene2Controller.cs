...
public class CutsceneController2 : MonoBehaviour {
	...
	void Start () {
		fadeStart ();
		quotes.Add ("\nEric: Great, we’ve geared ourselves up! \nNow, let’s get all of the lab equipment set up! Hmm… I seem to have forgotten the steps… \nCaitlin, can you grab me the book with the cure in it? It’s in my briefcase!\n");
		quotes.Add ("Caitlin: Sure thing!");
		quotes.Add ("Caitlin: Hey, Eric, what’s this? Doesn’t it look like the poison causing the outbreak as described in the book? \nWhy do you have it?-\n");
		...
		quotes.Add ("Eric: You’re not supposed to touch that--give it to me!");
		quotes.Add ("CRASH!!!");
